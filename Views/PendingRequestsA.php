        ...
        <div class="courses">
                ...
                <table class="req_list">
                    <thead>
                        <tr>
                            ...
                            <th>
                            <a href="?order=req_id&&sort=<?php echo $sort ?>"><h1>Requested By</h1></a>
                            </th>
                            <th>
			...
			?>
                    ...
                    <tr>
                            ...
                            <br>
                            <td>
                            <a href="deleterequest.php?course_id=<?php echo $course['course_id'];?>">
                                <button type="button" class="a_button" id='rej' >
                                Reject
                                </button>
                            </a>
                                <br>
                            <a href="statusupdate.php?id=<?php echo $course['course_id'];?>">
                                <button type="button" class="a_button" id='acc'>
                                Approve
                                </button>
                            </a>
                            </td>
