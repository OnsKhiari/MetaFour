<?php 
include 'C:\xampp\htdocs\ONS\uwu\controller\showpostsofcategory.php';
?>
...
<nav class="uwu">
    ...
    <div class="po2"></div>
    <div class="postreal2"></div>
    

      <?php if(isset($getpostsofcategory)){
    while($post=$getpostsofcategory->fetch()){
      echo '
      <a class="namecategory">'.$post['post_categoryname'].'</a>
    <div class="kekw">  
    <br><br><br><br><br><br>
    <div class="post"></div>';
      echo'
    ...
    <a href="#user" class="username">'.$post['post_username'].'</a>
