...
if(isset($_POST['sort']))
{
    $req_list = $CourseC->showcoursePSearched("Web Development", $_GET['searched'],$_POST['sort']);
}
else
{
    $req_list = $CourseC->showcoursePSearched("Web Development", $_GET['searched'],'course_id ASC');
}
