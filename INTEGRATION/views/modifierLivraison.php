            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- to get an API token!-->
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="modiflivraison.php" method="post">
						<html>
<head>
...
<input type="text" id="normale" name="id" value="<?php echo $_POST['id']; ?>" hidden>
<br>
<div>
