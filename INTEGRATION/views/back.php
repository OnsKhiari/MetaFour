			...
			?>
                ...
                <td><?php echo $commande['prix']; ?></td>
                        <td>
                          ...
                          <a href="supprimer_Commande.php?id=<?php echo $commande['id']; ?>"> <button type="button" class="btn btn-danger btn-sm btn-icon-text">
                              Supprimer
                              <i class="typcn typcn-delete-outline btn-icon-append"></i>                          
                            </button></a>
                          </div></td><td>
                          <div class="d-flex align-items-center">
                          <a href="email.php?email=<?php echo $commande['email']; ?>"> <button type="button" class="btn btn-danger btn-sm btn-icon-text">
                              confirmer commande
                              <i class="typcn typcn-delete-outline btn-icon-append"></i>                          
                            </button></a>
                          </div>
