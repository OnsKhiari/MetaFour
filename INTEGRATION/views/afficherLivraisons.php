    ...
    <body id="page-top">
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">LISTE DES LIVRAISONS :</h2>
                <!-- Icon Divider-->
...
<head>
	...
	<body>
		...
		<table border="1" align="center">
			...
			<?php
				foreach($listeLivraisons as $commande){
			?>
			<tr>
				<td><?php echo $commande['idlivraison']; ?></td>
				<td><?php echo $commande['type']; ?></td>
				<td><?php echo $commande['dateaj']; ?></td>
				<td><?php echo $commande['id_commande']; ?></td>
				<td>
					<form method="POST" action="modifierLivraison.php">
						<input type="submit" name="Modifier" value="Modifier">
						<input type="hidden" value="<?php echo $commande['idlivraison']; ?>" name="id">
					</form>
				</td>
				<td>
					<a href="supprimerLivraison.php?id=<?php echo $commande['idlivraison']; ?>">Supprimer</a>
				</td>
