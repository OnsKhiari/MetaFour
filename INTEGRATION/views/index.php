...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="home.php">Meta_Four</a>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">veuillez remplir ce formulaire :</h2>
                <!-- Icon Divider-->
                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="ajouterCommande.php" method="post">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="nom" name="nom" type="text" placeholder="ecrire votre nom..." data-sb-validations="required" />
                                <label for="name">Nom</label>
                                <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control" id="prenom" name="prenom" type="text" placeholder="Ecrire votre prenom..." data-sb-validations="required" />
                                <label for="name">Prenom</label>
                                <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div>
                            </div>
                          
                            <div class="form-floating mb-3">
                                <input class="form-control" id="code article" name="code_article" type="text" placeholder="Ecrire code article..." data-sb-validations="required" />
                            ...
                            <!-- Phone number input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="phone" type="tel" name="num" placeholder="(123) 456-7890" data-sb-validations="required" />
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="prix" type="number" name="prix"  style="height: 10rem" data-sb-validations="required"></textarea>
